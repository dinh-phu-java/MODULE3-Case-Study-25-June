...
<section class="content">
    <section class="block">
        <div class="container">
            <p>Owner List : <c:out value="${sessionScope.ownerUser.fullName}"/></p>
            <!--============ Section Title===================================================================-->
                ...
                <c:forEach items="${sessionScope.productList}" var="product">
                    <div class="item">
                        ...
                        <div class="wrapper">
                            ...
                            <!--end image-->
                            <h4 class="location">
                                <a href="#">${sessionScope.ownerUser.address}</a>
                            </h4>
                            ...
                            <div class="meta">
                                ...
                                <figure>
                                    <a href="#">
                                        <i class="fa fa-user"></i>${sessionScope.ownerUser.fullName}
                                    </a>
                                </figure>
                            </div>
                            <!--end meta-->
                    ...
                    <ul class="pagination">
                        <li class="page-item">
                            <a class="page-link"
                               ...
                               href="<c:url value="/home?action=owner-car-list&user-id=${sessionScope.ownerUser.id}&page=${sessionScope.page-1}"/>"
                               aria-label="Previous">
                        ...
                        <c:forEach var="i" begin="1" end="${sessionScope.listSize}">
                            <li class="page-item <c:if test="${sessionScope.page == i}"> active </c:if>">
                                <a class="page-link"
                                   href="<c:url value="/home?action=owner-car-list&user-id=${sessionScope.ownerUser.id}&page=${i}"/>">${i}</a>
                            </li>
                        </c:forEach>
